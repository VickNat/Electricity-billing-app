...
public class Login extends JFrame implements ActionListener {
    ...
    Login(){
        ...
        ImageIcon i1 = new ImageIcon(ClassLoader.getSystemResource("icon/LoginImage.jfif"));
        ...
        ImageIcon i3 = new ImageIcon(ClassLoader.getSystemResource("icon/Cancel.jfif"));
        ...
        ImageIcon i5 = new ImageIcon(ClassLoader.getSystemResource("icon/LoginImage.jfif"));
