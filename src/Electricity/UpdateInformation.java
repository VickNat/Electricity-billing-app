...
public class UpdateInformation extends JFrame implements ActionListener{
    ...
    UpdateInformation(String meter){
        ...
        lblmeternumber.setBounds(30,110,200,20);
        add(lblmeternumber);
        ...
        ImageIcon i1 = new ImageIcon(ClassLoader.getSystemResource("icon/update.jpg.png"));
    ...
    public void actionPerformed(ActionEvent ae){
        if(ae.getSource() == update){
            ...
            try{
                Conn c = new Conn();
                c.stmt.executeUpdate("update customer set address = '"+address+"', city = '"+city+"', state = '"+state+"', email = '"+email+"', phone = '"+phone+"' where meter_no = '"+meter+"'");
